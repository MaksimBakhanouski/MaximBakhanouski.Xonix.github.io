...
const xonixSPA = (function () {
  ...
  function ModuleView() {
    ...
    this.showCanvasMain = function () {//фуекция отображает пункты меню в зависимости от выбранного пункта меню
      ...
      const frameMain = `<iframe class = "iframe_center" src="https://www.youtube.com/embed/POhMfAFZ_6c?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`
